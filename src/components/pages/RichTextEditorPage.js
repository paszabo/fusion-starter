    ...
    <div>
      ...
      <Panel>
        ...
        <Well>
          ...
          <h4>Drart.js Usage Information</h4>
          ...
          <p>Draft.js is a framework for building rich text editors in React, powered by an immutable model and abstracting over cross-browser differences.
            ...
            at <Button bsStyle='link' style={{padding: 0}} href='https://facebook.github.io/draft-js/'>{'https://facebook.github.io/draft-js/'}</Button>.</p>

          <Button bsSize='large' block href='https://facebook.github.io/draft-js/'>View Draft.js Documentation</Button>
        </Well>
      </Panel>
