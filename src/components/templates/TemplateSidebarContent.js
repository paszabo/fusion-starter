...
const TemplateSidebarContent = () => {
  return(
    <Grid fluid className="template-page-wrapper page-wrapper__sidebar-content">
        <Col className="sidebar__fixed" sm={2} >
          <Panel>
            <div className="template-sidebar-wrapper sidebar-wrapper__sidebar-content">
              <h3>Vestibulum</h3>
        ...
        <Col className="content__fluid" sm={10}>
          <Panel>
            <div className="template-content-wrapper content-wrapper__sidebar-content">
              <h1>Sidebar/Content Layout</h1>
...
TemplateSidebarContent.propTypes ={};

TemplateSidebarContent.defaultProps ={};

export default TemplateSidebarContent;
