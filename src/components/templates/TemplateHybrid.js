...
const TemplateHybrid = () => {
  const Navigation = (
    <Row className="template-navigation-container">
      <Navbar fluid fixedTop={true} className="template-navigation template-navigation__hybrid" >
  ...
  return(
    <Grid fluid className="template-page-wrapper page-wrapper__hybrid">
        {Navigation}

      <Grid className="template-content-wrapper content-wrapper__hybrid">
        <h1>Hybrid Page Layout</h1>
