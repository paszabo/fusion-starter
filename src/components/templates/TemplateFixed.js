...
const TemplateFixed = () => {
  const Navigation = (
    <Row className="template-navigation-container">
      <Navbar fluid fixedTop={true} className="template-navigation template-navigation--fixed">
  ...
  return(
    <Grid fluid className="template-page-wrapper page-wrapper__fixed">
      {Navigation}

      <Grid className="template-content-wrapper content-wrapper__fixed">
        <h1>Fixed Width Page Layout</h1>
...
TemplateFixed.propTypes ={};

TemplateFixed.defaultProps ={};
